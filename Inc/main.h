...
/* Private defines -----------------------------------------------------------*/
#define Sonido1_Pin GPIO_PIN_0
#define Sonido1_GPIO_Port GPIOC
#define LCD_RST_Pin GPIO_PIN_1
#define LCD_RST_GPIO_Port GPIOC
#define Sonido2_Pin GPIO_PIN_2
#define Sonido2_GPIO_Port GPIOC
#define Sonido3_Pin GPIO_PIN_3
#define Sonido3_GPIO_Port GPIOC
